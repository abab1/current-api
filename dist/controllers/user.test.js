...
describe('user controller tests', function () {
  ...
  describe('createIfDoesntExist tests', function () {
    it('should not create a user if already exists with the same email', /*#__PURE__*/function () {
    ...
    it('should not create a user on validation failures', /*#__PURE__*/function () {
  ...
  describe('getAllUserTransactionsByMerchant tests', function () {
          ...
          while (1) {
            switch (_context13.prev = _context13.next) {
              case 0:
                ...
                _context13.next = 8;
                return _user["default"].getAllUserTransactionsByMerchant(req, res, next);
  ...
  describe('getUserBalance tests', function () {
    it('should send 200 status code and return transactions', /*#__PURE__*/function () {
          ...
          while (1) {
            switch (_context14.prev = _context14.next) {
              case 0:
                ...
                _context14.next = 7;
                return _user["default"].getUserBalance(req, res, next);
          ...
          while (1) {
            switch (_context15.prev = _context15.next) {
              case 0:
                ...
                Transaction.aggregate.mockRejectedValueOnce(new Error({
                  status: 500
                }));
                _context15.next = 8;
                return _user["default"].getUserBalance(req, res, next);
  ...
  describe('getUserTransactionSummary tests', function () {
    it('should send 200 response with trxn summary', /*#__PURE__*/function () {
      var _ref17 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee17(done) {
        var req, mockSend, res, next;
  ...
  describe('authorizeTransaction tests', function () {
    it('should send 200 with APPROVED code when balance is more than the trxn amount', /*#__PURE__*/function () {
      var _ref18 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee18(done) {
        var req, mockSend, res, next;
    ...
    it('should send 200 with APPROVED code when balance is same as the trxn amount', /*#__PURE__*/function () {
      var _ref19 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee19(done) {
        var req, mockSend, res, next;
    ...
    it('should send 200 with DECLINED code when balance is less than the trxn amoun', /*#__PURE__*/function () {
      var _ref20 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee20(done) {
        var req, mockSend, res, next;
